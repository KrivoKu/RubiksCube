...
void OLL::solveOLL(Solver& cube, RubiksCube& a) {
	if (!checkEdges(cube)) {
...
void OLL::solveCase(Solver& cube, int state, RubiksCube& a) {
	switch (state) {
	case 1:
		cube.moves("FRURRRUUUFFF", a);
		std::cout << "FRURRRUUUFFF";
		solveOLL(cube, a);
		break;
	case 2:
		cube.moves("BULUUULLLBBB", a);
		std::cout << "BULUUULLLBBB";
		solveOLL(cube, a);
		break;
	case 3:
		cube.moves("FRURRRUUUFFFBULUUULLLBBB", a);
		std::cout << "FRURRRUUUFFFBULUUULLLBBB";
		solveOLL(cube, a);
		break;
	case 4:
		cube.moves("RURRRURUURRR", a);
		std::cout << "RURRRURUURRR";
		break;
	case 5:
		cube.moves("RRRUUURUUURRRUUR", a);
		std::cout << "RRRUUURUUURRRUUR";
		break;
	case 6:
		cube.moves("FRURRRUUURURRRUUURURRRUUUFFF", a);
		std::cout << "FRURRRUUURURRRUUURURRRUUUFFF";
		break;
	case 7:
		cube.moves("RUURRUUURRUUURRUUR", a);
		std::cout << "RUURRUUURRUUURRUUR";
		break;
	case 8:
		cube.moves("RRDRRRUURDDDRRRUURRR", a);
		std::cout << "RRDRRRUURDDDRRRUURRR";
		break;
	case 9:
		cube.moves("LFRRRFFFLLLFRFFF", a);
		std::cout << "LFRRRFFFLLLFRFFF";
		break;
	case 10:
		cube.moves("FFFLFRRRFFFLLLFR", a);
		std::cout << "FFFLFRRRFFFLLLFR";
		break;
	}
}

int OLL::findState(Solver& cube) {
	int topLayer[9];
	int redSide[3];
	int greenSide[3];
	int orangeSide[3];
...
int OLL::checkEdges(Solver& cube) {
